...
RUN yum update -y && \
    ...
    rh-postgresql12-postgresql rh-postgresql12-postgresql-devel rh-postgresql12-postgresql-server \
...
RUN localedef -c -f UTF-8 -i en_US en_US.UTF-8 && \
    su - postgres -c "source /opt/rh/rh-postgresql12/enable && PGDATA=/var/lib/pgsql/data initdb" 