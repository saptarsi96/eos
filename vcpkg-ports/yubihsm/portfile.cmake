...
vcpkg_extract_source_archive_ex(
    ...
    REF ${YUBIHSM_VERSION}
    PATCHES
      0002_fix_pkg_search_module.patch
      0003_install_static_lib.patch
)

set(VCPKG_C_FLAGS "${VCPKG_C_FLAGS} -fno-lto -fcommon")
set(VCPKG_CXX_FLAGS "${VCPKG_CXX_FLAGS} -fno-lto -fcommon")
